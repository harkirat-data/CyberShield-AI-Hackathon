...
echo "  tail -f /home/\$USER/projects/valens-ai/logs/events.jsonl | python3 -m json.tool"
echo "  tail -f /home/\$USER/projects/valens-ai/logs/alerts.jsonl | python3 -m json.tool"
echo ""
...
echo "  rm -f /home/\$USER/projects/valens-ai/logs/*.jsonl"
